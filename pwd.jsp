...
<div class="w1200">
    ...
    <div class="m_d">
        <div class="left">
            <dl><dt>个人中心</dt>
                <dd>
                    <a href="${pageContext.request.contextPath}/center.jsp">个人资料</a>
                    <a href="${pageContext.request.contextPath}/pwd.jsp" class="on">修改密码</a>
        ...
        <div class="right">
            ...
            <dl class="dl02">
                ...
                <dd>
                    <form action="${pageContext.request.contextPath}/user/savePwd" method="post" enctype="multipart/form-data">
                        <div class="item"><span><font>*</font>账户名：</span><input type="text" class="txt" name="userName" /></div>
                        <div class="item"><span><font>*</font>原来密码：</span><input type="text" class="txt" name="password"/></div>
                        <div class="item"><span><font>*</font>新的密码：</span><input type="password" class="txt" name="newPwd"/></div>
                        <div class="item"><span><font>*</font>确认密码：</span><input type="password" class="txt" name="newPwd1"/></div>
