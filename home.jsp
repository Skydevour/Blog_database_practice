...
<nav class="ui inverted attached segment m-padded-tb-mini m-shadow-small" >
    <div class="ui container">
        <div class="ui inverted secondary stackable menu">
            ...
            <a href="${pageContext.request.contextPath}/index.jsp" class="m-item item m-mobile-hide">首页</a>
                    ...
                    <c:forEach items="${blogList}" var="blog">
                        <div class="ui padded vertical segment m-padded-tb-large">
                            <div class="ui mobile reversed stackable grid">
                                ...
                                <div class="eleven wide column">
                                    <h3 class="ui header" >
                                        <p onclick="showSingleBlog(${blog.vId})" class="m-black">
                                            <c:if test="${fn:length(blog.content) >0}">
                                                <a href="#" class="item">
                                    ...
                                    <p class="m-text">
                                        <c:if test="${fn:length(blog.content)>0 && fn:length(blog.content)<=50}">
                                            ${fn:substring(blog.content, 0, 50)}
                                        </c:if>
                                        <c:if test="${fn:length(blog.content) >50}">
                                            ${fn:substring(blog.content, 0, 50)}...
                                        </c:if>
                                    </p>
                                    <div class="ui grid">
                    ...
                    <div class="ui teal segment">
                        <div class="ui fluid vertical menu">
                            <c:forEach items="${blogList}" var="blog" begin="0" end="4">
                                <c:if test="${fn:length(blog.content) >0}">
                                    <a onclick="showSingleBlog(${blog.vId})" class="item">
                    ...
                    <div class="ui teal segment">
                        <div class="ui fluid vertical menu">
                            <c:forEach items="${hotList}" var="hot">
                                <c:if test="${fn:length(hot.content) >0}">
                                    <a onclick="showSingleBlog(${hot.vId})" class="item">
                                            ${fn:substring(hot.content, 0, 15)}...
                                    </a>
                                </c:if>
                            </c:forEach>
                        </div>
